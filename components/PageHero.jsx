...
export default function PageHero({ eyebrow, title, lead, image = "/images/hero.jpg", alt = "Bevu Social Farmstay — the brick house among granite boulders at dusk", position = "center 60%", crumbs }) {
  return (
    <section className="relative flex min-h-[62vh] items-end overflow-hidden bg-ink pt-[76px] text-cream">
      ...
      <div className="wrap relative pb-14 pt-24 md:pb-20">
        {crumbs && <div className="mb-6"><Breadcrumbs items={crumbs} tone="light" /></div>}
