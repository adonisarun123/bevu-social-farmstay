...
export function validateStay({ kind, roomSlugs, checkIn, checkOut, adults }) {
  ...
  if (kind === "house" && adults > 12) return "The whole house sleeps up to 12 with children. For larger groups, WhatsApp us.";
  return null;
}
